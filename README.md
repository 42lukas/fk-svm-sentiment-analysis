...
We used [this Website](https://colab.research.google.com/github/littlecolumns/ds4j-notebooks/blob/master/investigating-sentiment-analysis/notebooks/Cleaning%20the%20Sentiment140%20data.ipynb#scrollTo=TX8WqwSLyaR-) to download the Dataset.
...
```
Afterwards download the Sentiment140 dataset. 

If you donwloaded the dataset, import it and use the python scripts in the ```format_dataset``` folder to clean and noramlize it. Finally the whole dataset will be split up into 3 parts, train (80%), val (10%) and test (10%).
